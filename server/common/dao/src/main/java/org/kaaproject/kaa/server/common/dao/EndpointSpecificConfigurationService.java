...
public interface EndpointSpecificConfigurationService {
     ...
     */
    Optional<EndpointSpecificConfigurationDto> findActiveConfigurationByEndpointKeyHash(String endpointKeyHash);
     ...
     * @return the endpoint specific configuration
     */
    Optional<EndpointSpecificConfigurationDto> findByEndpointKeyHashAndConfSchemaVersion(String endpointKeyHash, Integer confSchemaVersion);
     ...
     */
    Optional<EndpointSpecificConfigurationDto> deleteActiveConfigurationByEndpointKeyHash(String endpointKeyHash);
     ...
     * @return deleted endpoint specific configuration
     */
    Optional<EndpointSpecificConfigurationDto> deleteByEndpointKeyHashAndConfSchemaVersion(String endpointKeyHash, Integer confSchemaVersion);
