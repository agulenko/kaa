...
public interface ConfigurationService extends RemoteService {
    ...
    EndpointSpecificConfigurationDto findEndpointSpecificConfiguration(String endpointKeyHash, Integer confSchemaVersion) throws KaaAdminServiceException;

    EndpointSpecificConfigurationDto deleteEndpointSpecificConfiguration(String endpointKeyHash, Integer confSchemaVersion) throws KaaAdminServiceException;
}
