...
public class DefaultControlService implements ControlService {
    ...
    @Override
    public EndpointSpecificConfigurationDto findEndpointSpecificConfiguration(String endpointKeyHash, Integer confSchemaVersion) {
    ...
    @Override
    public EndpointSpecificConfigurationDto deleteEndpointSpecificConfiguration(String endpointKeyHash, Integer confSchemaVersion) {
        Optional<EndpointSpecificConfigurationDto> result;
        if (confSchemaVersion == null) {
    ...
    private void sendEndpointConfigurationRefreshMessage(EndpointSpecificConfigurationDto configuration) {
        byte[] endpointKeyHashBytes = Base64Util.decode(configuration.getEndpointKeyHash());
